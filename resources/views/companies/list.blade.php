    ...
    <main class="flex-grow container mx-auto p-4 flex gap-6">
        <div class="container mx-auto p-4">
            ...
            <div>
                ...
                <form method="GET" action="{{ route('company.search') }}" class="flex flex-wrap gap-4 border p-4 rounded-md w-full m-2">
                    @csrf

                    <!-- Div Barre de Recherche + Bouton Rechercher-->
                    <div class="flex w-full items-center gap-2">
                        <input type="text" name="search" value="{{ request('search') }}" placeholder="Rechercher une entreprise..." class="flex-1 border p-2 rounded-md">
                        
                        <button type="submit" class="bg-blue-700 hover:bg-blue-400 text-white px-4 py-2 rounded-md flex-none">Rechercher</button>
                    </div>

                    <!-- Div Filtres -->
                    <div class="flex space-between w-full">
                        <!-- Filtre par secteur -->
                        <select name="sector" class="border p-2 rounded-md m-2">
                        ...
                        <!-- Filtre par ville -->
                        <select name="city" class="border p-2 rounded-md m-2">
                        ...
                        <!-- Trie -->
                        <select name="sort" class="border p-2 rounded-md m-2 ml-auto">
