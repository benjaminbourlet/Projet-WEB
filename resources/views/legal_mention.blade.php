        ...
        <div class="space-y-6 text-center">
            <div>
                ...
                <p class="text-gray-700">
                    ...
                    Email : <a href="mailto:contact@stagefinder.com"
                        class="text-blue-500 hover:underline">contact@stagefinder.com</a><br>
            ...
            <div>
                ...
                <p class="text-gray-700">
                    L’ensemble du contenu du site Stage Finder (textes, images, logo, etc.) est protégé par les droits
                    d’auteur.
                </p>
            </div>
            <br>
            <div>
                ...
                <p class="text-gray-700">
                    Les données collectées sur le site sont destinées à améliorer l’expérience des utilisateurs et ne seront
            ...
            <div>
                ...
                <p class="text-gray-700">
                    Lors de votre navigation, des « cookies » peuvent être stockés dans votre ordinateur. Vous pouvez à tout
                ...
                <ul class="list-disc list-inside text-gray-700 mt-2 space-y-2">
                    ...
                    <li><strong>Firefox :</strong> Menu > Options > Vie privée > Utiliser les paramètres personnalisés pour
                        l'historique.</li>
                    <li><strong>Edge :</strong> Menu > Paramètres > Cookies et autorisations de site > Gérer et supprimer
                        les cookies.</li>
                </ul>
            </div>
            <br>
            <div>
                ...
                <p class="text-gray-700">
                    ...
                    <a href="mailto:contact@stagefinder.com"
                        class="text-blue-500 hover:underline">contact@stagefinder.com</a>.
                </p>
            </div>
            <br>
            <div>
