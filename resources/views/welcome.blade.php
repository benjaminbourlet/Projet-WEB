...
<main class="bg-white">
    ...
    <div class="container mx-auto pt-20 text-center bg-100">
        <form method="GET" action="{{ route('offer_list') }}" class="relative w-2/3 mx-auto flex items-center">
            ...
            <input type="text" name="search" value="{{ request('search') }}" class="w-full pl-16 p-4 border-2 border-black rounded-full text-lg"
