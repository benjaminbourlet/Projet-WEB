      ...
      <div class="w-full p-6 md:w-1/2 bg-gray-100">
        ...
        <form method="POST" action="{{ route('login') }}">
          ...
          <div class="mb-4">
            ...
            <input type="email" id="email" name="email" class="w-full px-3 py-2 border rounded-md focus:outline-none focus:ring focus:ring-teal-500 bg-gray-300" required>
          </div>
          <div class="mb-6">
            <label for="password" class="block text-gray-700">Mot de passe</label>
            <input type="password" id="password" name="password" class="w-full px-3 py-2 border rounded-md focus:outline-none focus:ring focus:ring-teal-500 bg-gray-300" required>
          </div>
