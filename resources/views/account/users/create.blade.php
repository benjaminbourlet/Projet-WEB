...
<div class="max-w-md mx-auto mt-10 bg-white p-6 rounded-lg shadow-lg">
    ...
    <form method="POST" action="{{ route('userRegister') }}" enctype="multipart/form-data">
        ...
        <div>
            ...
            <input type="file" id="pp" name="pp" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 p-2">
        ...
        <div class="mb-4">
            ...
            <input type="text" id="first_name" name="first_name" value="{{ old('first_name') }}" required class="w-full mt-1 p-2 border rounded-md @error('first_name') border-red-500 @enderror">
            @error('first_name')
                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
            @enderror
        </div>
        ...
        <button type="submit" class="w-full bg-green-500 text-white p-2 rounded-md hover:bg-green-600">Créer le profil {{ $role }}</button>
