                ...
                <div class="grid md:grid-cols-2 grid-cols-1">
                    <div class="bg-[#5A8E95] p-4 rounded-lg">
                        <div class="m-4">
                            ...
                            <input type="file" id="pp" name="pp" class="mt-1 text-white block w-full border-gray-300 rounded-md shadow-sm">
                    ...
                    <div class="bg-gray-700 place-items-center p-4 rounded-lg">
                        ...
                        <button type="submit" class="w-3/4 bg-green-500 text-white px-8 py-2 rounded-full hover:bg-green-600 m-8">
