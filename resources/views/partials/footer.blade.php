        ...
        <div class="w-full flex flex-wrap items-center justify-between">
            <div class="flex items-center space-x-4">
                ...
                <a href="https://github.com/benjaminbourlet/Projet-WEB.git"><img
                        src="{{ asset('storage/images/logo_github.svg') }}" width="30" height="30" alt="GitHub"></a>
                <a href="https://x.com/MrBeast"><img src="{{ asset('storage/images/logo_twitter.svg') }}" width="30"
                        height="30" alt="X/Twitter"></a>
                <a href="https://www.instagram.com/benjamiin_brl/"><img
                        src="{{ asset('storage/images/logo_instagram.svg') }}" width="30" height="30" alt="Instagram"></a>
                <a href="https://www.linkedin.com/in/benjamin-bourlet-422b4032a/"><img
                        src="{{ asset('storage/images/logo_linkedin.svg') }}" width="30" height="30" alt="Linkedin"></a>
            </div>
