    ...
    <footer>
        <div class="bg-[#5A8E95] w-full flex flex-wrap items-center justify-between px-6">
            <div class="w-full lg:w-auto flex flex-row lg:flex-col items-center justify-center lg:justify-start">
                ...
                <div class="mx-6 py-4">
                    <button id="dropdown_country_button" data-dropdown-toggle="dropdown_country" class="text-white bg-gray-700 hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-xl px-7 py-3 text-center inline-flex items-center " type="button">Langue
                        <!-- focus ring pour mettre en evidence le bouton -->
                        <!-- Icone fleche -->
                        <img src="{{ asset('storage/images/dropdown_arrow.svg') }}" alt="fleche de menu" class="w-7 h-7 pt-1">
                        </button>
                        
                        <!-- Dropdown menu langue-->
                        <div id="dropdown_country" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow-sm w-44">
                ...
                <div class="mx-6 py-4">
                    <button id="dropdown_monney_button" data-dropdown-toggle="dropdown_monney" class="text-white bg-gray-700 hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-xl px-7 py-3 text-center inline-flex items-center " type="button">Monnaie
                        <!-- Icone fleche -->
                    <img src="{{ asset('storage/images/dropdown_arrow.svg') }}" alt="fleche de menu" class="w-7 h-7 pt-1">
                    </button>
                        
                        <!-- Dropdown menu devise-->
                        <div id="dropdown_monney" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow-sm w-44">
                ...
                <div class="grid grid-cols-2 lg:py-8 md:grid-cols-3 pr-4 py-6">
                    <div>
                        ...
                        <ul class="text-white font-medium">
                            ...
                            <li class="mb-4">
                                <a href="https://www.phenixtechnologie.fr/" class="hover:underline">PHÉNIX TECHNOLOGIE</a>
                            </li>
                            <li class="mb-4">
        ...
        <div class="w-full flex flex-wrap items-center justify-between">
            <div class="flex items-center space-x-4">
                <span class="block  text-white font-bold text-lg sm:text-center pl-4 pr-1">Nous suivre sur :</span>
            ...
            <span class="block text-white text-lg sm:text-center p-4"> Nous sommes un groupe en CPI A2 du CESI ™ . All Rights Reserved.</span>
        </div>
    </footer>
